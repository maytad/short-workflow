...
export const queryKeys = {
  projects: {
    ...
    assets: (projectId: string) =>
      [...queryKeys.projects.detail(projectId), "assets"] as const,
    ...
    renders: (projectId: string) =>
      [...queryKeys.projects.detail(projectId), "renders"] as const,
    scenes: (projectId: string) =>
      [...queryKeys.projects.detail(projectId), "scenes"] as const,
  },
};
