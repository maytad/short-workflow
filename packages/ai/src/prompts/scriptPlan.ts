      ...
      messages: [
        {
          ...
          content: [
            ...
            "The hook should create a small emotional reason to keep watching: surprise, tension, disbelief, relief, curiosity, or satisfying completion.",
            ...
            "The hidden cause can come from any safe image-readable physical behavior; mechanism-family labels describe the selected angle after the hook, not a menu to choose from.",
            "Avoid broad lectures and non-visual claims. Biology, perception, voice, optical, acoustic, thermal, material, fluid, electrical, geometric, and everyday chemical causes are allowed only when the selected topic has concrete visual evidence.",
            "Reject topics or angles that cannot show visible evidence of the cause on screen through action, contrast, sound-source clue, reflection, texture, residue, contact points, deformation, flow, state change, failure, or another image-readable effect.",
            "Use novelty axes before writing: creative territory, visual proof mode, viewer misconception, and visual strategy. If the angle feels too similar on more than two novelty axes, rewrite the angle while keeping the selected topic.",
            ...
            "Start with the visible surprise already happening, whether that is motion, contrast, contact points, deformation, force path, flow, texture, sound clue, residue, reflection shift, or visible failure.",
            "The first narration line must be no more than 8 words.",
            "The first caption must be no more than 4 words.",
            "The first caption must double as the generated-image hook headline: 2-4 plain English words, no punctuation, no labels, and no mechanism explanation.",
            "For scene 1, prefer a contradiction headline that makes the still image feel incomplete without the reveal, such as SHOULD LOCK, BACKWARD BUT FORWARD, STAYS SHUT, or WHY DID IT SLIP.",
            ...
            "Scene 1 must show a visible consequence already happening: motion, contrast, texture change, reflection shift, deformation, sound-source clue, residue, state change, resistance, or failure.",
            "Scene 1 must show a large visible consequence that reads in a still image; do not depend on subtle tail movement, tiny part alignment, or internal details as the hook.",
            "Scene 1 must preserve the mechanism mystery. Do not reveal the complete hidden cause or contact path in the first image prompt.",
            "Scene 1 caption and first narration must frame a contradiction, not explain the hidden cause. Do not reveal the mechanism before scene 2.",
            ...
            "The first spoken words must name the concrete object, action, consequence, or visible surprise on screen.",
            "",
            "# Pacing Rules",
            ...
            "",
            "# Visual-First Rules",
            "Each scene must choose one visualHookArchetype from: impossible_macro, consequence_first, hands_on_demo, before_after_contrast, frozen_motion, scale_shock, reveal_cutaway, blueprint_exploded_reveal.",
            ...
            "Each image prompt seed must describe a concrete vertical frame using subject + visible consequence already happening + camera viewpoint + explicit layout grammar.",
            "For each scene, make visualBrief explain what the viewer should understand from the image in under half a second.",
            "Image prompt seeds and visual briefs must not ask for embedded labels, explanatory callouts, UI, logos, or watermarks.",
            "For scene 1 only, the separate image prompt template will render the first caption as a graphic hook headline inside the image; do not add any other in-image text request to the imagePrompt seed.",
            "Hook image prompts must show the phenomenon already happening, not a calm setup before it happens.",
            "The first image prompt must show a visible consequence, contradiction, action, contrast, residue, deformation, resistance, or before-after change before any clean explanatory cutaway.",
            "The first image prompt must not ask for a sliced-away side window, transparent housing, blueprint sheet, or exploded teardown unless the visual surprise cannot be understood without it.",
            "If the selected object is small or dark, the first image prompt must force strong contrast through background, cord color, hand placement, silhouette, lighting, or a bold visible consequence.",
            ...
            "For at least one point or payoff scene, consider blueprint_exploded_reveal when the selected hidden cause has separable layers, a path through parts, or a hidden contact point.",
            "Blueprint exploded reveal prompts should use the structure of a technical product diagram adapted for Shorts: large recognizable hero object, compact 3-5 part exploded stack, small cross-section inset, unlabeled leader lines, dimension ticks without numbers, and one visible cause-effect path.",
            "Do not request full product poster exploded diagrams, labeled teardown boards, readable text, brand names, or 8-10 layer part stacks; those are too static and unreadable for Shorts.",
            "Blueprint exploded reveal prompts must stay anchored to a familiar real object and show active evidence such as force, motion, compression, reflection, texture, residue, heat marks, releasing, or contact points.",
