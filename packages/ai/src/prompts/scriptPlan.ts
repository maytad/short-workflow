      ...
      messages: [
        {
          ...
          content: [
            ...
            "Explain the mechanism in three concrete beats when possible: part moves, part catches or slides or locks or releases, output happens.",
            "Prefer tactile mechanical verbs over abstract explanations: slides, grabs, locks, releases, snaps, pulls, pushes.",
            "",
            "# Visual-First Rules",
