...
export const TINY_MECHANISMS_CHANNEL_BIBLE = [
  ...
  "Allowed topics: safe everyday objects or behaviors with one small hidden physical cause that can be shown visually; do not choose from a fixed mechanism menu.",
  ...
  "Topic gate: prefer everyday objects with an immediate visible consequence, a hidden physical cause, a common wrong assumption, and an explanation that fits three concrete cause-effect beats.",
  "Reject topics or angles that cannot show a visible proof on screen through action, contrast, surface behavior, sound-source clue, reflection, texture, residue, deformation, contact, state change, or another concrete visual effect.",
  "Novelty gate: keep the channel focused on visible hidden causes while varying creative territory, visual proof mode, viewer misconception, and visual strategy so recent videos do not feel templated.",
  ...
  "Image direction: social-native hidden-cause frames with familiar everyday objects, native settings, a visible consequence first, selective cutaways only after the hook, tactile material texture, and no embedded text except the exact scene-1 hook headline, logos, UI, or public figures.",
