...
export const TINY_MECHANISMS_ACTIVE_SEEDS: [TinyMechanismsSeed, ...TinyMechanismsSeed[]] = [
  {
    ...
    mechanismHint: "A rotating cam changes position on each press, alternately locking and releasing the refill.",
  ...
  },
  {
    ...
    mechanismHint: "The slider guides two angled rows of teeth into an interlocking path so pulling force tightens the joint instead of opening it.",
  ...
  },
  {
    ...
    mechanismHint: "Two one-way valves alternate between drawing liquid into the pump chamber and forcing it out through the nozzle.",
  ...
  },
  {
    ...
    mechanismHint: "A tiny suspended mass inside a motion sensor shifts relative to electrodes, letting software infer gravity direction.",
  ...
  },
  {
    ...
    mechanismHint: "The beveled latch face rides over the strike plate and compresses the spring on closing, but the flat back blocks opening until the handle retracts it.",
  ...
  },
  {
    ...
    mechanismHint: "Tiny clutch jaws open and close around the lead so each press releases, advances, and grips it again.",
  ...
  },
  {
    ...
    mechanismHint: "Pulling backward winds a spring through gears; releasing the car lets the spring unwind through the wheels.",
  ...
  },
  {
    ...
    mechanismHint: "Raised pins on a rotating cylinder pluck tuned metal teeth, and the spacing of pins sets the rhythm.",
  ...
  },
  {
    ...
    mechanismHint: "The piston creates pressure changes while one-way valves decide whether soap enters the chamber or exits the nozzle.",
  ...
  },
  {
    ...
    mechanismHint: "Overlapping iris blades slide together so their inner edges form a changing polygon that reads as a circle.",
  ...
  },
  {
    ...
    mechanismHint: "The runner slides along the shaft until a small spring catch locks it in place against the ribs' closing force.",
  ...
  },
  {
    ...
    mechanismHint: "Tiny hooks catch flexible loops across many contact points, then release one row at a time when peeled at an angle.",
  ...
  },
  {
    ...
    mechanismHint: "The escapement locks and unlocks the gear train in tiny steps, letting stored spring energy escape at a controlled rhythm.",
  ...
  },
  {
    ...
    mechanismHint: "A connecting rod turns crank rotation into back-and-forth sliding motion along a guide.",
  ...
  },
  {
    ...
    mechanismHint: "A return spring stores energy during the press and lifts the handle back after the staple is driven.",
  ...
  },
  {
    ...
    mechanismHint: "Pawls inside the freewheel engage teeth when pedaling forward and click over them when the wheel outruns the pedals.",
  ...
  },
  {
    ...
    mechanismHint: "A wound spring drives a gear train, while a timing mechanism resists the release so the dial returns gradually.",
  ...
  },
  {
    ...
    mechanismHint: "The pivot turns handle motion into concentrated blade force, with the cutting point moving as the blades close.",
  ...
  },
  {
    ...
    mechanismHint: "A check valve opens under forward pressure and closes when tire pressure tries to push air back.",
  ...
  },
  {
    ...
    mechanismHint: "A sliding collar traps small locking balls or tabs in a groove, blocking the connector from pulling apart until the collar moves back.",
  ...
  },
  {
    ...
    mechanismHint: "Each step rides on front and rear wheels following separate tracks that control the step angle through the whole path.",
  ...
  },
  {
    ...
    mechanismHint: "An inertia-sensitive lock reacts to sudden spool acceleration and catches the retractor teeth.",
  ...
  },
  {
    ...
    mechanismHint: "Moving the weight changes the pendulum's effective balance, changing how long each swing takes.",
  ...
  },
  {
    ...
    mechanismHint: "A compound lever multiplies finger force before the jaws close over a very small distance.",
  ...
  },
  {
    ...
    mechanismHint: "Small motors shift lens elements until contrast or phase alignment indicates the image is sharp at the sensor.",
  ...
  },
  {
    ...
    mechanismHint: "Ball bearings roll between nested rails, supporting weight while reducing sliding friction.",
  ...
  },
  {
    ...
    mechanismHint: "A feed gear bites the can rim and advances the opener while the cutting wheel slices just beside the seam.",
  ...
  },
  {
    ...
    mechanismHint: "Gear ratios trade speed for torque, so the output turns slower but can push with more twisting force.",
  ...
  },
  {
    ...
    mechanismHint: "Internal catches hold notches in the shackle; turning the key moves the plug and retracts those catches.",
  ...
  },
  {
    ...
    mechanismHint: "A coiled spring stores energy as the tape is pulled out, then rewinds the spool when the lock releases.",
  ...
  },
  {
    ...
    mechanismHint: "An off-center or shaped cam changes radius as it turns, pushing a follower up and letting it drop at specific moments.",
  ...
  },
  {
    ...
    mechanismHint: "A flexible pawl inside the head rides over angled teeth during tightening and digs into them when pulled backward.",
  ...
  },
  {
    ...
    mechanismHint: "The clip acts like a cantilever spring, flexing within its elastic range and returning when the force is removed.",
  ...
  },
  {
    ...
    mechanismHint: "A detent notch and small spring-loaded bump create preferred positions that resist movement until enough force is applied.",
  ...
  },
  {
    ...
    mechanismHint: "Rotating wheels align internal gates; when every gate lines up, a fence can drop and release the lock.",
  ...
  },
  {
    ...
    mechanismHint: "The switch moves which side of the pawl catches the ratchet teeth, changing the locked direction while the other direction slips.",
  ...
  },
  {
    ...
    mechanismHint: "The plate slides into angled rails, so clamping force wedges the camera mount sideways instead of relying only on screw friction.",
  ...
  },
  {
    ...
    mechanismHint: "A spring-loaded pawl catches the steep side of each tooth in one direction and slides over the angled side in the other.",
